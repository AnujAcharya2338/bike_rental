...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("SELECT id, name, password_hash FROM admin WHERE email = ?");
...
<head>
    ...
    <title>Admin Login - Bike Rental System</title>
...
<body>
    ...
    <main class="auth-container">
        <div class="auth-card">
            <h1>Admin Login</h1>
            <p class="auth-subtitle">Access admin panel</p>
